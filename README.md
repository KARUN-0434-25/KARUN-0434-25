...
### First-year B.TECH. CSE student | Frontend developer | 'HTML', CSS, JavaScript, C++, Python | Exploring full-stack, AI/ML, 'Blockchain' | Podcast lover | Cricket fan | Building practical projects
1st-year CSE student | Frontend developer | Skills: `HTML` | `CSS` | `JavaScript` | `C++` | `Python` | Exploring full-stack, AI/ML & Web3 | Podcast lover | Cricket fan | Building practical projects
